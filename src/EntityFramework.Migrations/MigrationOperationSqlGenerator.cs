...
namespace Microsoft.Data.Entity.Migrations
{
    ...
    public abstract class MigrationOperationSqlGenerator
    {
        ...
        public virtual string GenerateDataType(SchemaQualifiedName tableName, [NotNull] Column column)
        {
            ...
            var entityType = TargetModel.EntityTypes.Single(t => NameGenerator.FullTableName(t) == tableName);
            var property = entityType.Properties.Single(p => NameGenerator.ColumnName(p) == column.Name);
