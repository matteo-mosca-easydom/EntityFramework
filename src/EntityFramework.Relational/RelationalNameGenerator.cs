...
namespace Microsoft.Data.Entity.Relational
{
    public class RelationalNameGenerator
    {
        ...
        public virtual SchemaQualifiedName FullSequenceName([NotNull] ISequence sequence)
        {
        ...
        public virtual SchemaQualifiedName FullTableName([NotNull] IEntityType entityType)
        {
